...
<head>
    ...
    <title>@yield('title', 'Marketing') — SIMP-PRO</title>
...
<div class="sidebar">
    ...
    <a href="{{ route('marketing.dashboard') }}"
       class="nav-item {{ request()->routeIs('marketing.dashboard') ? 'active' : '' }}">
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
        Dashboard
    </a>

    <a href="{{ route('marketing.form-pengajuan') }}"
       class="nav-item {{ request()->routeIs('marketing.form-pengajuan') ? 'active' : '' }}">
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
        Form Pengajuan
    </a>

    <a href="{{ route('marketing.form-revisi.index') }}"
       class="nav-item {{ request()->routeIs('marketing.form-revisi.*') ? 'active' : '' }}">
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
        Form Revisi
    </a>

    <a href="{{ route('marketing.riwayat.index') }}"
       class="nav-item {{ request()->routeIs('marketing.riwayat.*') ? 'active' : '' }}">
