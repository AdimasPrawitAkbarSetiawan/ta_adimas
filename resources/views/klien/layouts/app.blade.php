...
<head>
    ...
    <title>@yield('title', 'Klien') — SIMP-PRO</title>
...
<div class="sidebar">
    <div class="logo-wrap">
        <img src="{{ asset('images/logo_simppro.png') }}" alt="SIMP-PRO" class="h-20 w-full object-contain"
...
function loadChatUsers() {
    fetch('/chat/users').then(r => r.json()).then(users => {
        ...
        list.innerHTML = users.map(u => `
            <div onclick="openChatWith(${u.id}, '${u.name}')"
