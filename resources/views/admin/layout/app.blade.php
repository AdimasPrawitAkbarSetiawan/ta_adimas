...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="logo-wrap">
            <img src="{{ asset('images/logo_simppro.png') }}" alt="SIMP-PRO"
...
function loadNotifications() {
    fetch('/notifications').then(r => r.json()).then(data => {
        ...
        list.innerHTML = data.map(n => `
            <div class="px-4 py-3 border-b border-gray-50 ${n.is_read ? '' : 'bg-blue-50'}">
...
function sendChatMsg() {
    ...
    fetch('/chat/send', {
        ...
        body: JSON.stringify({ receiver_id: activeChatUserId, message })
    }).then(() => {
        input.value = '';
        loadChatMessages();
    });
